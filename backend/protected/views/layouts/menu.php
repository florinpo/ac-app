...
$this->widget('zii.widgets.CMenu', array(
    ...
    'items' => array(
        ...
        //Company Menu 
        array(
            'label' => '<span id="menu_user" class="micon"></span>' . t('cms', 'Company'),
            'url' => 'javascript:void(0);',
            'linkOptions' => array('id' => 'menu_6', 'class' => 'menu_6'),
            'itemOptions' => array('id' => 'menu_6'),
            'items' => array(
                array(
                    'label' => t('cms', 'Create Company'),
                    'url' => array('/company/create'),
                    'active' => Yii::app()->controller->id == 'company' && Yii::app()->controller->action->id == 'create'
                ),
                array(
                    'label' => t('cms', 'Manage Companies'),
                    'url' => array('/company/admin'),
                    'active' => ((Yii::app()->controller->id == 'company') && (in_array(Yii::app()->controller->action->id, array('update', 'view', 'admin', 'index')))) ? true : false
                ),
                array(
                    'label' => t('cms', 'Create Category'),
                    'url' => array('/company/createcategory'),
                    'active' => Yii::app()->controller->id == 'company' && Yii::app()->controller->action->id == 'createcategory'
                ),
                array(
                    'label' => t('cms', 'Manage Categories'),
                    'url' => array('/company/managecategories'),
                    'active' => Yii::app()->controller->id == 'company' && Yii::app()->controller->action->id == 'managecategories'
                ),
//              
            ),
            'visible' => user()->isAdmin ? true : false,
        ),
        array('label' => '<span id="menu_user" class="micon"></span>' . t('cms', 'Membership'), 'url' => 'javascript:void(0);', 'linkOptions' => array('id' => 'menu_6', 'class' => 'menu_6'), 'itemOptions' => array('id' => 'menu_6'),
            'items' => array(
                array(
                    'label' => t('cms', 'Manage orders'),
                    'url' => array('/membership/manageorders'),
                    'active' => Yii::app()->controller->id == 'membership' && Yii::app()->controller->action->id == 'manageorders'
                    ),
                 array(
                    'label' => t('cms', 'Manage plans'),
                    'url' => array('/membership/admin'),
                    'active' => Yii::app()->controller->id == 'membership' && Yii::app()->controller->action->id == 'admin'
                    ),
                array(
                    'label' => t('cms', 'Create plan'),
                    'url' => array('/membership/create'),
                    'active' => Yii::app()->controller->id == 'membership' && Yii::app()->controller->action->id == 'create'
                    ),
            ),
            'visible' => user()->isAdmin ? true : false,
        ),
        //Products menu
        array('label' => '<span id="menu_content" class="micon"></span>' . t('cms', 'Products'), 'url' => 'javascript:void(0);', 'linkOptions' => array('id' => 'menu_6', 'class' => 'menu_6'), 'itemOptions' => array('id' => 'menu_6'),
            'items' => array(
                array('label' => t('cmsl', 'Manage Products'), 'url' => array('/productsale/admin'),
                    'active' => ((Yii::app()->controller->id == 'productsale') && (in_array(Yii::app()->controller->action->id, array('update', 'view', 'admin', 'index')))) ? true : false
                ),
                array('label' => t('cmsl', 'Create Category'), 'url' => array('/productsale/createcategory')),
                array('label' => t('cmsl', 'Manage Categories'), 'url' => array('/productsale/managecategories'),
                    'active' => ((Yii::app()->controller->id == 'beproductsale') && (in_array(Yii::app()->controller->action->id, array('updatecategory', 'viewcategory', 'managecategories')))) ? true : false
                ),
            ),
            'visible' => user()->isAdmin ? true : false,
        ),
        //Permission Menu    
        array(
            'label' => '<span id="menu_caching" class="micon"></span>' . t('cms', 'Permission'),
            'url' => array('/rights/assignment'), 'linkOptions' => array('id' => 'menu_7', 'class' => 'menu_7'),
        ...
        // Store layouts menu
        array(
            'label' => '<span id="menu_user" class="micon"></span>' . t('cms', 'Store layouts'),
            'url' => 'javascript:void(0);',
            'linkOptions' => array('id' => 'menu_3', 'class' => 'menu_3'),
            'itemOptions' => array('id' => 'menu_3'),
            'items' => array(
                array(
                    'label' => t('cms', 'Create Store'),
                    'url' => array('/store/create'),
                    'active' => Yii::app()->controller->id == 'store' && Yii::app()->controller->action->id == 'create'
                ),
                array(
                    'label' => t('cms', 'Manage Store layouts'),
                    'url' => array('/store/admin'),
                    'active' => ((Yii::app()->controller->id == 'store') && (in_array(Yii::app()->controller->action->id, array('update', 'view', 'admin', 'index')))) ? true : false
                ),
            ),
            'visible' => user()->isAdmin ? true : false,
        ),
        ...
        //Caching Menu    
        array('label' => '<span id="menu_caching" class="micon"></span>' . t('cms', 'Caching'), 
            'url' => array('/caching/cachemanagement'), 'linkOptions' => array('id' => 'menu_8', 'class' => 'menu_8'), 
