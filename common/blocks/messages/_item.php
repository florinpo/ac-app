...
$date = itemsDate($data->last_message_ts);
$itemCssClass = $data->isUnread($userid, $this->folder) ? 'msg-unread' : 'msg-read';
...
<td class="gridCenter">
    <?php
    $mrclass = $data->isUnread($userid, $this->folder) ? 'visible' : 'hidden';
    ...
    ?>
    <?php
    $muclass = $data->isUnread($userid, $this->folder) ? 'hidden' : 'visible';
