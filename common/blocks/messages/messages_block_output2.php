<section id="ys-messages">
    <div class="box_round_c grid_19 omega">
        ...
        $this->widget('zii.widgets.CMenu', array(
            ...
            'items' => array(
                array(
                    'label' => "<span class='icon icon-edit'></span>".t('site', 'Componi'),
                ...
                array(
                    'label' => "<span class='icon icon-address-book'></span>".t('site', 'Rubrica'),
