<div id="favorite-items" class="nav-tabs-ls">
    ...
    <div class="nav-body results clearfix">
        ...
        $this->widget('zii.widgets.CListView', array(
            ...
            'id' => 'items-favorite-shops',
            'itemsTagName' => 'ul',
            'itemsCssClass' => 'shops-grid-view clearfix',
