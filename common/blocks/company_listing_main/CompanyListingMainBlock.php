 ...
 */
class CompanyListingMainBlock extends CWidget {

    //Do not delete these attr block, page and errors
    public $id = 'company_listing_main';
    public $block = null;
    public $errors = array();
    public $page = null;
    public $layout_asset = '';
            ...
            if (isset($_GET['cat'])) {
                ...
                if ($cat_id) {
                    ...
                    if ($category) {
                        ...
                        $this->render('common.blocks.company_listing_main.company_listing_main_subcatecategory_view', array('category'=>$category, 'slug'=>'catalogo-aziende'));
                    } else {
                ...
                $slugview = 'catalogo-aziende';
                $categories = CompanyCats::model()->findAll(array('order' => 'name ASC', 'condition' => 'level=1'));
