    ...
    protected function renderContent() {
        if (isset($this->block) && ($this->block != null)) {
            ...
            if ($display_type == 'grid') {
                ...
                header('Location: ' . Yii::app()->request->url);
                exit(0);
...
//                            $criteria->addCondition('t.delivery_type=1 OR t.delivery_type=2');
//                            $criteria->with += array(
//                                'provinces' => array(
...
//                            );
//                            
//                            //$criteria->addCondition('provinces.id NOT NULL');
...
//                        $criteria->order = 'company.has_membership DESC, cprofile.companyname ASC';
//
...
//                                    )
//                                ));
                        $model=new UserCompanyShop('search');
