...
<section id="products_categories" class="grid_18 alpha box_widget">
    <div class="header">
        <h2><?php echo t('site', 'Categorie di prodotti') ?></h2>
    </div>
    <div class="content">
                    ...
                    if (count($subcats_lev2) > 0) {
                        ...
                        foreach ($subcats_exclude as $k => $id) {
                            if ($k < 4) {
                                ...
                                $subcategory = ProductSaleCategoryList::model()->findByPk($subcats_exclude[$k]);
