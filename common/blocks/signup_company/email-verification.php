<div class="box_widget grid_24 alpha">
    ...
    <div class="reg-step">
        ...
        <span class="selected"><?php echo t("site", "3. Verifica email"); ?></span>
    ...
    <a href="<?php echo FRONT_SITE_URL.'register-comp/?op=email-verification&key='.$key.'&email='.$email; ?>"><?php echo FRONT_SITE_URL.'register-comp/?op=email-verification&key='.$key.'&email='.$email;?></a>
    <?php var_dump(app()->session['registerForm']); ?>
    <div>
</div>
