...
<html lang="it" class="no-js">
    ...
    <head>
        ...
        $cs->registerCSSFile($layout_asset . '/css/store_layout.css');
        $cs->scriptMap = array(
...
//            'jquery-ui.min.js'=>"https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/jquery-ui.min.js",
        ...
        $cs->registerScriptFile($layout_asset . '/js/jquery.carouFredSel.js');
        $cs->registerScriptFile($layout_asset . '/js/jquery.colorbox-min.js');
