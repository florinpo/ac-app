...
?>
<?php $this->renderPartial('common.layouts.store.header', array('page' => $page, 'layout_asset' => $layout_asset)); ?>      
<body>
    <!-- begin container -->
    <div id="container">
        <!-- begin header -->
        ...
        <section id="content_wrapper">
            <div class="container_24">
                <!-- begin top-content -->
                <div id="top-content" class="grid_24 clearfix">
                    <?php
                ...
                <!-- end top-content -->
                <!-- begin sidebar -->
                <div id="sidebar" class="grid_9 omega">
                    <?php
                ...
                <!-- end sidebar -->
                <!-- begin content-info -->
                <div id="content-info" class="grid_15 alpha">
                    <?php
                    //Render Widget for Content Region			
    ...
    <?php
    //Render Widget for Footer Region
    $this->widget('BlockRenderWidget', array('page' => $page, 'region' => '7', 'layout_asset' => $layout_asset));
    ?>
