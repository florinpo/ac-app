(function($) {
    ...
    $.statistics.updateStatistics = function() {
        ...
        //        var test = 1386826529842.93;
        //        var t = [];
        //        var diff = []
        //        $.each(whole_data, function(i, v){
        //            t.push(v[0]);
        //            if ($.inArray(test, t) == -1) {
        //                test = closestDate(t, test);
        //            }
        //            
        //            if(whole_data[i][0] >= test) {
        //                diff.push([whole_data[i][0], whole_data[i][1]]);
        //            }
        //            
        //        });
        //        console.log(test);
    ...
    $.statistics.drawGraph = function(points) {
        ...
        $("#c-placeholder").bind("plotselected", function (event, ranges) {
            ...
            var new_months = $.statistics.firstDayMonth(ticks, 4);
            ...
            //console.log(overview.getOptions());
            
            if(ranges.xaxis.from <=min ){
        ...
        $("#c-overview").bind("plotpan", function (event, plot) {
            var axes = plot.getAxes();          
            var el = axes.xaxis.min.toFixed(2);
            var el_fixed;
            console.log(el);
            ...
            if ($.inArray(el, t) == -1) {
                el_fixed = closestDate(t, el);
            }
            
            $.each(data, function(i, v){
                if(data[i][0] >= el_fixed) {
            ...
            console.log(el_fixed + " " + axes.xaxis.max.toFixed(2) )
