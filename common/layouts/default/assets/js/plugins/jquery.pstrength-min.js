    ...
    A.extend(A.fn,{
        pstrength:function(B){
            ...
            return this.each(function(){
                ...
                A(this).after("<div id=\"password-strength\"></div>");
                A("#password-strength").append("<div class=\"pstrength-info\" id=\""+C+"_text\"></div>");
                A("#password-strength").append("<div class=\"pstrength-bar\" id=\""+C+"_bar\" style=\"border: 1px solid white; font-size: 1px; height: 5px; width: 0px;\"></div>");
